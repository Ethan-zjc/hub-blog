...
<p class="codepen" data-height="300" data-theme-id="light" data-default-tab="js,result" data-user="zhangjinchao" data-slug-hash="YzXqNMO" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="动态组件">
  <span>See the Pen <a href="https://codepen.io/zhangjinchao/pen/YzXqNMO">
  动态组件</a> by zhangjinchao (<a href="https://codepen.io/zhangjinchao">@zhangjinchao</a>)
